...
```{r}
# original levels
meta_winter$Age_Estimate <- factor(meta_winter$Age_Estimate, levels = c("Subadult","Calf","Adult"))
meta_winter$Site_2 <- factor(meta_winter$Site_2, levels = c("Bavarian_Forest","Sumava","Neureichenau"))
meta_winter$HuntingMonth <- factor(meta_winter$HuntingMonth, levels = c("January","August","September","October","November","December"))

summary(glm(Fluke~Sex + Site_2 + Age_Estimate + HuntingMonth, data = meta_winter, family = "binomial"))

# relevel
meta_winter$Age_Estimate <- factor(meta_winter$Age_Estimate, levels = c("Adult", "Subadult","Calf"))
meta_winter$Site_2 <- factor(meta_winter$Site_2, levels = c("Sumava","Neureichenau","Bavarian_Forest"))
meta_winter$HuntingMonth <- factor(meta_winter$HuntingMonth, levels = c("August","September","October","November","December","January"))

summary(glm(Fluke~Sex + Site_2 + Age_Estimate + HuntingMonth, data = meta_winter, family = "binomial"))

# relevel
meta_winter$HuntingMonth <- factor(meta_winter$HuntingMonth, levels = c("September","October","November","December","January","August"))

summary(glm(Fluke~Sex + Site_2 + Age_Estimate + HuntingMonth, data = meta_winter, family = "binomial"))

# relevel
meta_winter$HuntingMonth <- factor(meta_winter$HuntingMonth, levels = c("October","November","December","January","August","September"))

summary(glm(Fluke~Sex + Site_2 + Age_Estimate + HuntingMonth, data = meta_winter, family = "binomial"))

# relevel
meta_winter$HuntingMonth <- factor(meta_winter$HuntingMonth, levels = c("November","December","January","August","September","October"))
...
```{r}
SupplFig2 <- ggarrange(fluke.sex, fluke.age, fluke.season, ncol=3, common.legend = TRUE, legend = "right")
SupplFig2
```
